...
import { Button, colors, IconBook, IconRun, IconTime, IconView } from 'app/ui/utils/styles';
import { useAppDispatch } from 'app/core/redux/hooks';
import { getModuleAndParentTrackSaga } from 'app/core/features/module/moduleTrackSaga';
    ...
    <ContentSection>
      ...
      <TrackDetails>
        ...
        <DetailRow>
          ...
          <div>
            <StyledLink to={`${url}/module/${modules[0]['id']}`}>
              <Button icon={<IconRun width="20px" />} color="#f25cc1" size="large">
                Start Track
              </Button>
            </StyledLink>
          </div>
